...
func (a *App) initGRPCServer(ctx context.Context) error {
	...
	desc.RegisterProductCatalogServiceServer(a.grpcServer, a.serviceProvider.ProductCatalogImpl(ctx))
...
func (a *App) initHTTPServer(ctx context.Context) error {
	...
	err := desc.RegisterProductCatalogServiceHandlerFromEndpoint(ctx, mux, a.serviceProvider.GRPCConfig().Address(), opts)
	if err != nil {
		return err
	}
